...
OsgPainter::OsgPainter(const std::string & name, ResourceManager & resourceManager, const std::map<std::string, std::string> & relDataPaths)
: Painter(name, resourceManager, relDataPaths)
, m_viewer(nullptr)
, m_embedded(nullptr)
, m_scene(nullptr)
, m_viewportX(0)
